...
# 源目录和目标目录
SRC_DIR="/mnt/sdcard/musl"
DST_DIR="/home/stl/osnational/oskernel2025-npucore-blossom/user/LaTest/musl"
...
FILES=(
    ...
    date.lua dlopen_dso.so entry-dynamic.exe entry-static.exe file_io.lua hello
