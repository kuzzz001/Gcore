...
pub const SYSCALL_MINICORE: usize = 232;
pub const SYSCALL_MADVISE: usize = 233;
pub const SYSCALL_PROCESS_VM_READV: usize = 234;
pub const SYSCALL_PROCESS_VM_WRITEV: usize = 235;
pub const SYSCALL_KCMP: usize = 236;
